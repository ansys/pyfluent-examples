"""
016-Part-2-Dash-App-for-Post-processing
==========================================
...
#                                 id="main_in_temp",
#                                 value=300,
#                                 marks={i: "{}".format(i) for i in range(250, 370, 20)}, # noqa: E501
#                             ),
...
#                                 [
#                                     dcc.Checklist(
#                                         ["Initialize"], ["Initialize"], id="initialize" # noqa: E501
#                                     )
#                                 ],
...
#                                 dcc.Tab(
#                                     label="Fluent Transcript", value="tab-2-transcript"  # noqa: E501
#                                 ),
#                             ],
#                         ),
#                         html.Div(
...
#         session.setup.boundary_conditions.velocity_inlet["cold-inlet"].t = main_in_temp  # noqa: E501
